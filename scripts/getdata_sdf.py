...
if __name__ == "__main__":
    ...
    try:
        ...
        URI_FILE = os.path.join(SCRIPT_DIR, "../data/450_3.uri") # Using the SDF.gz file URLs
        ...
        sdf_dir = os.path.join(SCRIPT_DIR, "../data/450_3/ligands_sdf")
        ...
        split_dir = os.path.join(SCRIPT_DIR, "../data/450_3/ligands_sdf_split")
