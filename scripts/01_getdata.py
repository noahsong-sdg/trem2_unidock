#!/usr/bin/env python3
"""
Data download script with comprehensive timing functionality.
...
if __name__ == "__main__":
    ...
    try:
        RAW_LIGANDS_DIR = os.path.join(SCRIPT_DIR, "../data/ligands_raw")
        URI_FILE = os.path.join(SCRIPT_DIR, "../data/column_one.uri") # Using the PDBQT.gz file URLs
        ...
        # Extract PDBQT files to the standard location
        pdbqt_dir = os.path.join(SCRIPT_DIR, "../data/ligands_pdbqt")
        ...
        if successful_extractions > 0:
            ...
            print("\n  WARNING: No PDBQT files were successfully extracted. Check the download and extraction logs.")
